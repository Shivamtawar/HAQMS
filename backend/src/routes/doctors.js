...
// GET /api/doctors
// Retrieve list of doctors with safe parameterized filtering via Prisma ORM
...
// Returns aggregation details — all four DB calls fire in parallel via Promise.all
